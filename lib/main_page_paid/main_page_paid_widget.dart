      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20, 36, 0, 10),
                child: Row(
                          ...
                          return InkWell(
                            onTap: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ProgramEntryPaidWidget(
                                    refFormList:
                  ...
                  child: StreamBuilder<List<MindfulnessSessionsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<MindfulnessSessionsRecord>
                          listViewMindfulnessSessionsRecordList = snapshot.data;
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        scrollDirection: Axis.horizontal,
                        itemCount: listViewMindfulnessSessionsRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                ...
                child: Container(
                  ...
                  child: StreamBuilder<List<LiveSessionsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<LiveSessionsRecord> listViewLiveSessionsRecordList =
                          snapshot.data;
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        shrinkWrap: true,
                          ...
                          return InkWell(
                            onTap: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => SessionEntryPaidWidget(
                                    refFromSessionsList:
