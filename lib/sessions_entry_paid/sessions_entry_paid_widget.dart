...
class SessionsEntryPaidWidget extends StatefulWidget {
  const SessionsEntryPaidWidget({Key key}) : super(key: key);

  @override
  _SessionsEntryPaidWidgetState createState() =>
      _SessionsEntryPaidWidgetState();
}

class _SessionsEntryPaidWidgetState extends State<SessionsEntryPaidWidget> {
